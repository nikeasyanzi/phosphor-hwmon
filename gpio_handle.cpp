    ...
    const std::string& gpiochip, const std::string& line)
{
    ...
    lg2::error("Unable to handle giochip entry {GPIOCHIP}",
                      "GPIOCHIP", gpiochip.c_str()
               );
        return nullptr;
    }
    ...
    lg2::error("Unable to handle line entry {}",
               "LINE" , line.c_str()
               );
        return nullptr;
    }
    ...
    lg2::error("Unable to set up GPIO handle {ERROR}",
               "ERROR",e.what()
               );
        return nullptr;
    }
